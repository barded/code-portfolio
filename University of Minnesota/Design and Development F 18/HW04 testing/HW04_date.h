...
#ifndef HW04_HW04_DATE_H_
#define HW04_HW04_DATE_H_
...
class Date {
 public:
  /**
    * Constructors
  **/
  Date(void);  // ssCurrent date
  Date(int year, int month, int day);

  /**
    * Constructor
    * param [in] epoch: an approximation of the number of seconds that
  ...
  /**
    ...
    * param [out] New Date object representing the date which is "days"
    number of days after the date currently stored
    **/
