...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    ballet_special2_.TrimBack(10);
    ballet_special2_.CalcRelativeTranslations();

    ballet_special3_.LoadFromAMC(Platform::FindFile("05_07.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special3_.TrimFront(250);
    ballet_special3_.TrimBack(120);
    ...
    ballet_special4_.TrimFront(190);
    ballet_special4_.TrimBack(10);
    ...
    ballet_special5_.TrimFront(1200);
...
void DanceApp::OnMotion2BtnPressed() {
  ...
  ballet_ant_.OverlayClip(ballet_special2_, 120);
}
...
void DanceApp::OnMotion4BtnPressed() {
  // TODO: add a call similar to this:
  ballet_ant_.OverlayClip(ballet_special4_, 250);
}
